...
import com.hk.gateway.dto.UserCouponDto;
import com.hk.gateway.dto.UserSubscriptionBooleanDTO;
import com.hk.gateway.pojo.Permission;
import com.hk.gateway.pojo.Role;
import com.hk.gateway.pojo.User;
import com.hk.gateway.service.RoleService;

/**
 * Created by IntelliJ IDEA. User: Vaibhav Date: Apr 25, 2013 Time: 5:56:08 PM
 */
public class UserResponse extends AbstractBaseResponse {
	...
	public UserResponse(User user, Long storeId) {
		...
		UserSubscriptionBooleanDTO userSubscriptionBooleanDTO = new UserSubscriptionBooleanDTO(
				user.getSubscribedMask());
	...
	protected List<Object> getValues() {
		...
		valueList.add(null); // don't change this value -- password should not be passed in response -- this
								// is only to give support to older version of android/ios
