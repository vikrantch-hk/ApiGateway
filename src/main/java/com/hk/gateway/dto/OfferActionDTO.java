...
import com.hk.gateway.pojo.es.ESOfferAction;

/**
 * Created by IntelliJ IDEA. User: Vaibhav Date: Jul 23, 2013 Time: 1:58:08 PM
 */
public class OfferActionDTO implements Serializable {
	...
	/*
	 * private Long applicableOnExpressionId; private int maxFreeVariants;
	 */

	/*
	 * public Long getIncludingExpressionId() { return includingExpressionId; }
	 * 
	 * public void setIncludingExpressionId(Long includingExpressionId) {
	 * this.includingExpressionId = includingExpressionId; }
	 * 
	 * public Long getExcludingExpressionId() { return excludingExpressionId; }
	 * 
	...
	/*
	 * public OfferActionDTO(OfferAction offerAction) { this.id =
	 * offerAction.getId(); this.storeId = offerAction.getStoreId();
	 * this.offerActionTypeId = offerAction.getOfferActionTypeId(); this.discount =
	 * offerAction.getDiscount(); this.discountMaxLimit =
	 * offerAction.getDiscountMaxLimit(); this.cashBackExpiryDate =
	 * offerAction.getCashBackExpiryDate(); this.includingExpressionId =
	 * offerAction.getIncludingExpressionId(); this.excludingExpressionId =
	 * offerAction.getExcludingExpressionId();
	 */
	/*
	...
	/*
	 * public Long getApplicableOnExpressionId() { return applicableOnExpressionId;
	 * }
	 * 
	 ...
	 * 
	 * public int getMaxFreeVariants() { return maxFreeVariants; }
	 * 
	 * public void setMaxFreeVariants(int maxFreeVariants) { this.maxFreeVariants =
	 * maxFreeVariants; }
	 */
