...
import com.hk.gateway.pojo.es.ESOfferTrigger;

/**
 * Created by IntelliJ IDEA. User: Vaibhav Date: Jul 23, 2013 Time: 1:58:17 PM
 */
public class OfferTriggerDTO implements Serializable {
	...
	/*
	 * public OfferTriggerDTO(OfferTrigger offerTrigger) { this.id =
	 * offerTrigger.getId(); this.storeId = offerTrigger.getStoreId();
	 ...
	 * this.minAmount = offerTrigger.getMinAmount(); this.maxAmount =
	 * offerTrigger.getMaxAmount(); this.maxQty = offerTrigger.getMaxQty();
