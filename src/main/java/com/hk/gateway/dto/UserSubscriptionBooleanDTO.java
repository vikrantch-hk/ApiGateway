...
import com.hk.gateway.constant.UserConstants;

/**
 * Created by IntelliJ IDEA. User: Vaibhav Date: Mar 18, 2013 Time: 5:52:15 PM
 */
public class UserSubscriptionBooleanDTO {
	...
	public int generateBoolBitset() {
		...
		boolBitset = this.smsSubscribed != null && this.smsSubscribed ? boolBitset * UserConstants.SUBSCRIBE_SMS
				: boolBitset;
		boolBitset = this.emailSubScribed != null && this.emailSubScribed ? boolBitset * UserConstants.SUBSCRIBE_EMAIL
				: boolBitset;
		return boolBitset;
	}
