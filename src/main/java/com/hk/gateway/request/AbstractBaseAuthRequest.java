...
public class AbstractBaseAuthRequest extends AbstractBaseRequest {
	...
	// LoggerFactory.getLogger(AbstractBaseAuthRequest.class);
	...
	protected boolean validate() {
		 ...
		 * logger.error("Error validating " + this.getClass().getSimpleName() +
		 * " api access key cannot be null"); valid = false; }
		 */
