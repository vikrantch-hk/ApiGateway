...
import com.hk.gateway.constant.EnumPlatformType;

/**
 * Created by IntelliJ IDEA. User: Vaibhav Date: Mar 22, 2013 Time: 2:56:53 PM
 */
public class AbstractBaseRequest implements Serializable {
	...
	protected boolean validate() {
		...
		if (valid && platformId != null && EnumPlatformType.getEnumPlatformTypeById(platformId) == null) {
			logger.error("Error validating " + this.getClass().getSimpleName() + " platform id " + platformId
					+ "is invalid");
			valid = false;
		}
