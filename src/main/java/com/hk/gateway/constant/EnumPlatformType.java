...
/**
 * Created with IntelliJ IDEA. User: Abhay Bhatia Date: 11/14/14 Time: 1:34 PM
 */
public enum EnumPlatformType {

	DESKTOP(1L, "Desktop", "D"), MOBILEWEB(2L, "MobileWeb", "M"), ANDROID(3L, "Android", "A"), IOS(4L, "iOS", "I");
