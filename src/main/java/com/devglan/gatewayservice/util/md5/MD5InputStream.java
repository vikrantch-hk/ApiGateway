package com.devglan.gatewayservice.util.md5;
...
public class MD5InputStream extends FilterInputStream {
	...
	public int read() throws IOException {
		...
		if ((c & ~0xff) != 0) {
			// System.out.println("MD5InputStream.read() got character with (c & ~0xff) !=
			// 0)!");
		} else {
			md5.Update(c);
		}
	...
	/**
	 * Returns array of bytes representing hash of the stream as finalized for the
	 * current state.
	 *
